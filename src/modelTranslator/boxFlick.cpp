...
boxFlick::boxFlick(int _clutterLevel): modelTranslator(){
...
MatrixXd boxFlick::returnRandomStartState(){
    ...
    mujocoHelper->getBodyPose_angle("goal", objectCurrentPose, mujocoHelper->mjDataMaster);
    objectCurrentPose.position(0) = startX;
    objectCurrentPose.position(1) = startY;
    mujocoHelper->setBodyPose_angle("goal", objectCurrentPose, mujocoHelper->mjDataMain);
    mujocoHelper->setBodyPose_angle("goal", objectCurrentPose, mujocoHelper->mjDataMaster);

    mujocoHelper->getBodyPose_angle("mainObstacle", objectCurrentPose, mujocoHelper->mjDataMaster);
    objectCurrentPose.position(0) = startX;
    objectCurrentPose.position(1) = startY;
    objectCurrentPose.position(2) = 0.2;
    mujocoHelper->setBodyPose_angle("mainObstacle", objectCurrentPose, mujocoHelper->mjDataMain);
    mujocoHelper->setBodyPose_angle("mainObstacle", objectCurrentPose, mujocoHelper->mjDataMaster);
...
double boxFlick::costFunction(std::shared_ptr<mjData> d, bool terminal){
    double cost = 0.0f;
...
void boxFlick::costDerivatives(std::shared_ptr<mjData> d, MatrixXd &l_x, MatrixXd &l_xx, MatrixXd &l_u, MatrixXd &l_uu, bool terminal){
    MatrixXd Xt = returnStateVector(d);
    MatrixXd Ut = returnControlVector(d);
    MatrixXd X_diff = Xt - X_desired;
...
bool boxFlick::taskComplete(std::shared_ptr<mjData> d, double &dist){

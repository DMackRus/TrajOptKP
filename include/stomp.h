...
public:
    stomp(modelTranslator *_modelTranslator, physicsSimulator *_physicsSimulator, fileHandler *_yamlReader, differentiator *_differentiator, int _maxHorizon, int rolloutsPerIter);

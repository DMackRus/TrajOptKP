...
//void MuJoCoHelper::getDerivatives(MatrixXd &A, MatrixXd &B, bool costDerivs, int dataIndex){
...
//void MuJoCoHelper::setModelTranslator(modelTranslator *_modelTranslator) {
